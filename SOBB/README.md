...
> **Note**: Before training, edit the `dataset_dir` paths in the config file to point to your local SSDD/SSDD+ dataset. See [ssdd.md](../docs/ssdd.md) for dataset preparation instructions.

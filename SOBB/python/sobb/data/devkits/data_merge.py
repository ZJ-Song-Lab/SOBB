...
from sobb.models.boxes.box_ops import rotated_box_to_poly_single
from sobb.data.devkits.result_merge import mergebypoly, mergebyobb
import os
import shutil
from tqdm import tqdm
import numpy as np
from sobb.data.devkits.dota_to_fair import dota_to_fair, dota_to_fair1m_1_5
...
if __name__ == "__main__":
    work_dir = "/mnt/disk/lxl/sobb/work_dirs/gliding_r101_fpn_1x_dota_bs2_tobgr_steplr_rotate_balance_ms"
    epoch = 12

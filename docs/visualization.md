...
```python
# vis_gt.py
from SOBB.utils.visualization import visualize_dota_ground_truth
...
<img src="https://github.com/Jittor/SOBB/blob/visualization/docs/images/vis2.jpg?raw=true" alt="Visualization" width="800"/>
...
```python
# vis_dota.py
from SOBB.utils.visualization import visualize_dota
...
You can also use `SOBB.utils.visualization.visualize_results` or `SOBB.utils.draw.draw_bboxes` to customize your own visualization. For the useage of the two functions, you can refer to :
- `python/SOBB/visualization.py:visualize_dota_ground_truth`
- `python/SOBB/visualization.py:visualize_dota`
- `python/SOBB/runner/runner.py:Runner.run_on_images`
```python
# input
